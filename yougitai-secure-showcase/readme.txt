...
= 1.0.35 =
* Fixed redaction-marker colors so the saved backend fill/edge colors override dark/auto theme defaults reliably.
* Added an explicit localized redaction tooltip on mouse hover and keyboard focus.
* Tooltip text follows the active WordPress locale (German/English).

= 1.0.34 =
* Added independent repository-browser hover/background/text, active marker/background, and focus-ring color settings.
* Added a redaction legend that explains how to find partially redacted files and fully protected files.
* Redaction-marker color remains configurable and localized hover/focus explanations remain available.
